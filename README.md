...
### For Debian/Ubuntu:
    ...
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/fotopedia-discovery-grab.git; cd fotopedia-discovery-grab; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/fotopedia-discovery-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, fotopedia-discovery-grab will not work with your rsync version.**
...
3. Run `pip2 install seesaw requsts`.
4. Modify the run-pipeline script in seesaw to point at `#!/usr/bin/python2` instead of `#!/usr/bin/python`.
5. `adduser --system --group --shell /bin/bash archiveteam`
6. `screen su -c "cd /home/archiveteam/fotopedia-discovery-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
Have an issue not listed here? Join us on IRC and ask! We can be found at irc.efnet.org #fotofinished.
